...
Initially based on VRCVideoCacher, this app "VRCVideoCacherPlus" adds many improvements, like HLS and streaming playlist (.m3u8) video support.
...
Steam app is not supported, for now. SteamVR integration is tested (e.g. starting this app with SteamVR)
